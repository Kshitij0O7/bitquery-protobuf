...
| **Protobuf Kafka (EVM Example)** | Example for decoding EVM chains data data streams        | [View Example](https://docs.bitquery.io/docs/streams/protobuf/chains/EVM-protobuf/?utm_source=github_readme&utm_medium=referral&utm_campaign=bitquery_protobuf&utm_content=protobuf_kafka_docs&utm_term=protobuf_kafka) |
| **Protobuf Kafka (Solana Example)** | Example for decoding Solana data streams        | [View Example](https://docs.bitquery.io/docs/streams/protobuf/chains/Solana-protobuf/?utm_source=github_readme&utm_medium=referral&utm_campaign=bitquery_protobuf&utm_content=protobuf_kafka_docs&utm_term=protobuf_kafka) |
| **Protobuf Kafka (Tron Example)** | Example for decoding Tron data streams        | [View Example](https://docs.bitquery.io/docs/streams/protobuf/chains/Tron-protobuf/?utm_source=github_readme&utm_medium=referral&utm_campaign=bitquery_protobuf&utm_content=protobuf_kafka_docs&utm_term=protobuf_kafka) |
